  ...
  return (
    <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
      ...
      >
        ...
        <p className="mt-6 text-sm font-medium cursor-pointer">Upload Image</p>
        <input
      ...
      {/* Right col */}
      <div className="w-full max-w-lg p-4 bg-white rohnded-lg flex flex-col border border-gray-200 min-h-96">
        <div className="flex items-center gap-3">
        ...
        {!content ? (
          <div className="flex-1 flex justify-center items-center">
            <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
              ...
              <p>Upload an image and "Remove Object" to get started</p>
            </div>
          </div>
        ) : (
